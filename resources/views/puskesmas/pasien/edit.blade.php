              ...
              <div class="card-header">
                  <div class="btn-group dropright">
                      ...
                      <div class="dropdown-menu p-0">
                          <a class="dropdown-item bg-primary" href={{route('puskesmas.record.create', ['id'=> $patient->id])}}>+Kunjungan</a>
                          <a class="dropdown-item bg-success" href={{route('puskesmas.patient', ['id'=> $patient->id])}}>Detail</a>
                          <a class="dropdown-item bg-warning" href={{route('puskesmas.patient.edit', ['id'=> $patient->id])}}>Edit</a>
                          <a class="dropdown-item bg-danger" href="#" data-toggle="modal" data-target="#modal-delete-{{$patient->id}}">Hapus</a>
                      </div>
                  </div>
              </div>
              <div class="card-body">
                <form action={{route('puskesmas.patient.edit', ['id'=>$patient->id])}} class="" method="post">
                @csrf
                @method('patch')
                <div class="row">
                  <div class="col-lg-6">
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action={{route('puskesmas.patient.delete', ['id' => $patient->id])}} class="dropdown-item" method="post">
                  @csrf
                  @method('delete')
