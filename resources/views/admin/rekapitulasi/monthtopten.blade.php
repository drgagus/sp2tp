...
@section('rekapitulasibulan1')
menu-open
@endsection

@section('rekapitulasibulan2'.$year)
menu-open
@endsection

@section('rekapitulasibulan3'.$year.$month)
menu-open
@endsection

@section('rekapitulasibulan4topten'.$year.$month)
active
@endsection
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">10 Penyakit Terbesar<br>Bulan {{$bulan[$month]}} Tahun {{$year}} </h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
