      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action={{route('admin.servicecenter.edit', ['id' => $servicecenter->id])}} class="" method="post">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tempatpelayanan" id="tempatpelayanan" class="form-control" value="{{ old('tempatpelayanan') ?? $servicecenter->tempatpelayanan}}" placeholder="--nama tempat pelayanan--">
