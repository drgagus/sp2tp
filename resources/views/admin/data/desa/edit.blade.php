      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action={{route('admin.village.edit', ['id'=> $village->id])}} class="" method="post">
                        @csrf
                        @method('patch')
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="desa" id="desa" class="form-control" value="{{ old('desa') ?? $village->desa}}" placeholder="--nama desa/kelurahan--">
                                @error('desa')
