      ...
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action={{route('admin.servicesubunit.create')}} class="" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                            @if (session('status'))
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="poli" id="poli" class="form-control" value="{{ old('poli') ?? ''}}" placeholder="--nama poli/sub unit pelayanan--">
                                @error('poli')
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-9">
                                                ...
                                                @csrf
                                                <div class="form-group">
                                                    <select class="custom-select" name="employe_id">
