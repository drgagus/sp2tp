    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href={{route('pustu.dashboard')}} class="dropdown-item">
              <i class="fas fa-tachometer-alt  mr-3"></i>Dashboard
          </a>
          <a href={{route('pustu.setting')}} class="dropdown-item">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href={{route('pustu.dashboard')}} class="nav-link @yield('dashboard' ?? '')">
          ...
          <li class="nav-item">
            <a href={{route('pustu.patient.index')}} class="nav-link @yield('caripasien' ?? '')">
          ...
          <li class="nav-item has-treeview @yield('pasien' ?? '')">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item pl-2">
                <a href={{route('pustu.patient.village', ['desa' => $village->id])}} class="nav-link @yield('pasiendesa'.$village->id ?? '')">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item pl-2 has-treeview @yield('kunjungan2'.$t ?? '')">
                ...
                <ul class="nav nav-treeview">
                  @for($i = 1; $i <=  12 ; $i++  )
                  <li class="nav-item pl-2">
                    <a href={{route('pustu.record.yearmonth', ['tahun'=>$t, 'bulan'=>$i])}} class="nav-link @yield('kunjungan3'.$t.$i ?? '')">
          ...
          <li class="nav-item">
            <a href={{route('pustu.diagnosa')}} class="nav-link @yield('diagnosa' ?? '')">
              <i class="nav-icon fas fa-circle"></i>
              <p>
                Diagnosa
              </p>
          ...
          <li class="nav-item">
            <a href={{route('pustu.setting')}} class="nav-link @yield('setting')">
