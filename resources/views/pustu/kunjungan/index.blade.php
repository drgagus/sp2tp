                        ...
                        <td>
                          <div class="btn-group dropright">
                              ...
                              <div class="dropdown-menu p-0">
                                  <a class="dropdown-item bg-warning" href={{route('pustu.record.edit', ['id'=> $record->id])}}>Edit</a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form action={{route('pustu.record.delete', ['id' => $record->id])}} class="dropdown-item" method="post">
                  @csrf
                  @method('delete')
                  <div class="row">
                    <div class="col-lg-12">
