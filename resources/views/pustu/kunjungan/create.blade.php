        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="card card-dark border border-dark">
              ...
              <div class="card-body">
                <form action={{route('pustu.record.create', ['id'=>$patient->id])}} class="" method="post">
                @csrf
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      <label for="tanggalkunjungan">Tanggal Kunjungan</label>
                      <input type="date" class="form-control" id="tanggalkunjungan" name="tanggalkunjungan" placeholder="--tanggal kunjungan--" value="{{old('tanggalkunjungan') ?? ''}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="pasien" id="Baru" {{ old('pasien')  === "Baru" ? 'checked':'' }} value="Baru">
                            <label class="form-check-label" for="Baru">Baru</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="pasien" id="Lama" {{ old('pasien')  === "Lama" ? 'checked':'' }} value="Lama">
                    ...
                    <div class="form-group">
                      ...
                      @foreach ($diags as $diag)
                        <option {{ old('diag_id')  === $diag->id ? 'selected':'' }} value="{{$diag->id}}" class="">{{$diag->kode}} {{$diag->diagnosa}}</option>
                      @endforeach
                      </select>
                      @error('diag_id')
