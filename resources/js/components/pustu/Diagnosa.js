...
function Diagnosa(props) {
    ...
    const getDiagnosa = async () =>{
        try{
            let response = await axios.get(`/pustu/diagnosa/${diagnosa}`)
...
if (document.getElementById('diagnosaPustu')) {
    var item = document.getElementById('diagnosaPustu')
    ReactDOM.render(<Diagnosa/>, document.getElementById('diagnosaPustu'));
}
